...
const Vision = () => {
  return (
    <>
      <Heading as="h1">Ma vision</Heading>
      <Text>
        J’investit la plupart de mon énergie pour porter une vision qui gravite
        autour de trois sujets qui sont pour moi fondamentaux : l’économie
        circulaire, la connaissance et la liberté.
      </Text>
      <Heading as="h2">L’économie circulaire</Heading>
      <Text>
      ...
      <Text as="i">Pourquoi ignorer cela ? Pourquoi mépriser la Nature ?</Text>
      <Heading as="h2">La connaissance</Heading>
      <Text>
      ...
      <Heading as="h2">La liberté</Heading>
      <Text>
      ...
      <Text as="i">Pourquoi se priver de liberté ?</Text>
    </>
  )
}
